...
from krita_stable_diffusion.dist.server.torch.multiprocessing import queue
...
class StableDiffusionRunner(Connection):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.queue is None:
            raise ValueError("queue must be passed to StableDiffusionRunner")
